export class StyleSwitcher {
	...
	static _STYLE_THEME_NIGHT_OLED = "nightOled";
	...
	static _CLASS_THEME_NIGHT_OLED = "ve-night-mode--oled";
	...
	static _STYLE_THEME_TO_DISPLAY_NAME = {
		...
		[this._STYLE_THEME_NIGHT_OLED]: "Night Mode (OLED)",
	};
	...
	_setActiveStyleThemeClasses (styleResolved) {
		...
		switch (styleResolved) {
			...
			case StyleSwitcher._STYLE_THEME_NIGHT_OLED: {
				document.documentElement.classList.add(StyleSwitcher._CLASS_THEME_NIGHT);
				document.documentElement.classList.add(StyleSwitcher._CLASS_THEME_NIGHT_OLED);
				break;
			}
		}
	}
	...
	getClassNamesStyleTheme () {
		switch (this._getResolvedStyleTheme()) {
			...
			case StyleSwitcher._STYLE_THEME_NIGHT_OLED: return [StyleSwitcher._CLASS_THEME_NIGHT, StyleSwitcher._CLASS_THEME_NIGHT_OLED].join(" ");
		}
	}
	// endregion
