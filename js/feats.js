...
class FeatsPage extends ListPage {
	...
	getListItem (feat, ftI, isExcluded) {
		...
		eleLi.innerHTML = `<a href="#${hash}" class="ve-lst__row-border ve-lst__row-inner">
			...
			<span class="ve-bold ve-col-3-5 ve-px-1">${feat.name}</span>
			<span class="ve-col-3-5 ve-px-1 ${feat._slAbility === VeCt.STR_NONE ? "ve-italic " : ""}">${feat._slAbility}</span>
